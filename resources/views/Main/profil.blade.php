                ...
                <form action="{{ route('profil.update') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="jenis_kelamin" value="{{ old('jenis_kelamin', $akun->mahasiswa->jenis_kelamin ?? '') }}" placeholder="-" class="w-full border border-slate-200 rounded-xl px-5 py-3 text-sm font-semibold text-slate-700 focus:border-[#7c3aed] outline-none transition-all">
                        </div>
                        <div>
